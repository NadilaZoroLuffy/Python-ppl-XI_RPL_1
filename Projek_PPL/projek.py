...
if tipe == 1:
    ...
    bangun = kubus(sisi = int(input("Masukkan sisi : ")))
    bangun.tampilkan_kubus()
    garis()

elif tipe == 2:
    Luas_bangun = ("tabung")

    bangun = tabung(r = int(input("Masukkan r : ")))
    bangun = tabung(tinggi = int(input("Masukkan tinggi : ")))
    bangun.tampilkan_tabung()
    garis()
